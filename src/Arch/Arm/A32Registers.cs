...
namespace Reko.Arch.Arm
{
    public static class A32Registers
    {
        ...
        static A32Registers()
        {
            ...
            r0 = RegisterStorage("r0", 0);
            r1 = RegisterStorage("r1", 1);
            r2 = RegisterStorage("r2", 2);
            r3 = RegisterStorage("r3", 3);
            r4 = RegisterStorage("r4", 4);
            r5 = RegisterStorage("r5", 5);
            r6 = RegisterStorage("r6", 6);
            r7 = RegisterStorage("r7", 7);
            r8 = RegisterStorage("r8", 8);
            r9 = RegisterStorage("r9", 9);
            r10 = RegisterStorage("r10", 10);
            r11 = RegisterStorage("fp", 11);
            ip = RegisterStorage("ip", 12);
            sp = RegisterStorage("sp", 13);
            lr = RegisterStorage("lr", 14);
            pc = RegisterStorage("pc", 15);
