...
{
    public class InternalPowerPcDisassembler : DisassemblerBase<PowerPcInstruction>
    {
        ...
        {
            public abstract PowerPcInstruction Decode(InternalPowerPcDisassembler dasm, uint wInstr);
        }

        private class InvalidOpRec  : OpRec
        {
            public override PowerPcInstruction Decode(InternalPowerPcDisassembler dasm, uint wInstr)
            {
        ...
        static InternalPowerPcDisassembler()
        {
            oprecs = new OpRec[] {
                // 00
                new InvalidOpRec(),
