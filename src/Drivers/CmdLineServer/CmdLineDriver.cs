...
namespace Reko.CmdLineServer
{
    public class CmdLineDriver
    {
        ...
        public static void Main(string[] args)
        {
            ...
            services.AddService<CmdLineServer>(new CmdLineServer(services, Console.In, Console.Out, Console.Error));
            var listener = new CmdLineListener(services)
            {
        ...
        {
            var srv = services.RequireService<CmdLineServer>();   
            srv.Start();
            srv.Join();
        }
